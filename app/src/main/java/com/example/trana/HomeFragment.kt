...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Search bar click -> Navigate to Navigation fragment
        view.findViewById<View>(R.id.et_search_home)?.setOnClickListener {
            findNavController().navigate(R.id.action_home_to_navigation)
        }

        // Profile click -> Navigate to Profile fragment
        view.findViewById<View>(R.id.iv_profile_home)?.setOnClickListener {
            findNavController().navigate(R.id.action_home_to_profile)
        }

        // Call button
        view.findViewById<View>(R.id.btn_call_home)?.setOnClickListener {
            Toast.makeText(requireContext(), "Calling emergency services...", Toast.LENGTH_SHORT).show()
        }

        // SOS button
        view.findViewById<View>(R.id.btn_sos_home)?.setOnClickListener {
